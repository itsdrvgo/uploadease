...
export function generatePathTitle(path: string = "/dashboard/organizations") {
...
export function generateInviteLink(inviteCode: string, orgId: string) {
    return getAbsoluteURL("/invites/" + orgId + "/" + inviteCode);
}

export function isFileTypePermitted(file: File, fileTypes: string[]) {
